...
if ($mailSent) {
    ...
    $autoReplyBody .= "info@gstgrp.com\n";
    $autoReplyBody .= "0574526903";
    
    $autoReplyHeaders = "From: info@gstgrp.com\r\n";
    $autoReplyHeaders .= "Reply-To: info@gstgrp.com\r\n";
